namespace B20_Ex05.GameObjects
{
    public class CardInMemoryGame
    {
        ...
        // Parameters:  char - the current card value
        //              int - card position on board
        // Return: Constructor
        internal CardInMemoryGame(char i_CardValue, int i_WidthIndexOnBoard, int i_HeightIndexOnBoard)
        {
